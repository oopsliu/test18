Return this exact JSON:
    ...
    `{"header": "NOAA Marine Debris Monitoring and Assessment Project - Transect Survey", "subHeader": "Please complete this form for each transect surveyed at your designated site. Record site information, observations on debris, and upload relevant documentation. Accurate data supports marine debris tracking and mitigation efforts.", "questions": [{"type": "esriQuestionTypeGroup", "label": "Transect Information", "questions": [{"type": "esriQuestionTypeText", "label": "Site Name (as listed in MDMAP database)", "isRequired": true}, {"type": "esriQuestionTypeDate", "label": "Date of Survey (MM/DD/YYYY)", "isRequired": true}]}, {"type": "esriQuestionTypeGroup", "label": "Location and Timing", "questions": [{"type": "esriQuestionTypeNumber", "label": "Transect Start (0-95 in 5m increments)", "isRequired": true}, {"type": "esriQuestionTypeNumber", "label": "Beach Width (meters, water's edge to back barrier)", "isRequired": true}, {"type": "esriQuestionTypeTime", "label": "Search Start Time (HH:MM local)", "isRequired": true}, {"type": "esriQuestionTypeTime", "label": "Search End Time (HH:MM local)", "isRequired": true}]}, {"type": "esriQuestionTypeGroup", "label": "Site Conditions", "questions": [{"type": "esriQuestionTypeSingleChoice", "label": "Slope (Standing at water's edge, back barrier height)", "isRequired": true, "choices": ["knees and below", "knees to shoulders", "shoulders and above"]}, {"type": "esriQuestionTypeSingleChoice", "label": "Primary Substrate (Predominant surface)", "isRequired": true, "choices": ["mud/silt", "sand", "pebble/gravel", "cobble", "other (describe in notes)"]}, {"type": "esriQuestionTypeSingleChoice", "label": "Back Barrier (Landward limit - check one)", "isRequired": true, "choices": ["dune", "cliff", "boulders", "parking lot", "vegetation", "wall/structure", "dense driftwood", "other (describe in notes)"]}]}, {"type": "esriQuestionTypeGroup", "label": "Debris Search Details", "questions": [{"type": "esriQuestionTypeSingleChoice", "label": "Search Team Size (Number of people, max 2)", "isRequired": true, "choices": ["1", "2"]}, {"type": "esriQuestionTypeSingleChoice", "label": "Debris Removal (How much was removed from transect)", "isRequired": true, "choices": ["all/most", "some", "none"]}, {"type": "esriQuestionTypeSingleChoice", "label": "Consistency Check (Was a consistency check conducted?)", "isRequired": true, "choices": ["yes", "no"]}, {"type": "esriQuestionTypeNote", "label": "If a consistency check was required, take close-up photos of items that lacked consensus and describe them in the notes below."}]}, {"type": "esriQuestionTypeImage", "label": "Debris Photo (Upload a clear photo documenting observed debris at this site)", "isRequired": true, "maxFileCount": 3}, {"type": "esriQuestionTypeTextArea", "label": "Notes (Describe debris observed, classify by type/category)", "isRequired": true}, {"type": "esriQuestionTypeGeoPoint", "label": "Transect Location (Provide GPS coordinates via map)", "isRequired": true}, {"type": "esriQuestionTypeAudio", "label": "Verbal Notes/Observations (Record optional audio notes about the transect)", "isRequired": false}], "thankYouScreen": "Thank you for submitting your transect data to the NOAA Marine Debris Monitoring and Assessment Project. Your participation helps us understand and address marine debris issues nationwide."}`
